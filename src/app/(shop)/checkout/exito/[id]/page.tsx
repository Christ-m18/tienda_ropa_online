  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-2xl">
      <div className="bg-white rounded-3xl border border-zinc-200 p-10 text-center">
        ...
        <h1 className="font-display text-4xl md:text-5xl tracking-tight">¡Pedido confirmado!</h1>
        <p className="text-zinc-500 mt-2">Pedido #{order.id.slice(0, 8).toUpperCase()} · {formatDate(order.created_at)}</p>
