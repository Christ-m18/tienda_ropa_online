...
const INITIAL: Message[] = [
  {
    role: 'assistant',
    content: '¡Qué lo qué! Soy El Cuero, tu asistente de TIENDA RD. Pregúntame sobre productos, envíos o pagos. 🇩🇴',
  },
]
      ...
      {open && (
        ...
        >
          <div className="bg-rd-charcoal text-white p-4 flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-lg tracking-wider">EL CUERO</p>
